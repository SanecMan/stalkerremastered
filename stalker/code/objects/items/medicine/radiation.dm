/obj/item/reagent_containers/hypospray/medipen/stalker/antirad
	name = "Anti-rad"
	desc = "Набор таблеток с активными веществами, способствующими выведению радионуклидов из организма. Не способны защитить организм от наведённой радиации, но снижают уже полученную человеком дозу. Комплект расчитан на 2 применения."
