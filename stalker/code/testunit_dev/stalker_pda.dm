		...
		//�������
				...
				if(1)
					if(user.client.prefs.chat_toggles & CHAT_LANGUAGE)
						...
						navbarhtml ="| <a>�������</a> | <a href='byond://?src=\ref[src];choice=3'>�������</a> | <a href='byond://?src=\ref[src];choice=4'>�����</a> |<br>"
		...
		//������������
				...
				if(2)
					if(user.client.prefs.chat_toggles & CHAT_LANGUAGE)
						...
						navbarhtml ="| <a href='byond://?src=\ref[src];choice=1'>�������</a> | <a href='byond://?src=\ref[src];choice=3'>�������</a> | <a href='byond://?src=\ref[src];choice=4'>�����</a> |<br>"
		...
		//�������
				...
				if(3)
					if(user.client.prefs.chat_toggles & CHAT_LANGUAGE)
						...
						navbarhtml ="| <a href='byond://?src=\ref[src];choice=1'>�������</a> | <a>�������</a> | <a href='byond://?src=\ref[src];choice=4'>�����</a> |<br>"
		...
		//�����
				...
				if(4)
					if(user.client.prefs.chat_toggles & CHAT_LANGUAGE)
						...
						navbarhtml ="| <a href='byond://?src=\ref[src];choice=1'>�������</a> | <a href='byond://?src=\ref[src];choice=3'>�������</a> | <a>�����</a> |<br>"
			...
			if(!t)
				...
				if ( !(last_lenta && world.time < last_lenta + LENTA_MESSAGE_COOLDOWN) )
					...
					if(H.client.prefs.chat_toggles & CHAT_LANGUAGE)
						...
						to_chat(H, "<span class='warning'>�� ������� ��������� ��������� ��������� �����: [round((LENTA_MESSAGE_COOLDOWN + last_lenta - world.time)/10)] ���.</span>")
			...
			if(!t)
				...
				if ( !(last_faction_lenta && world.time < last_faction_lenta + LENTA_FACTION_MESSAGE_COOLDOWN) )
					...
					if(H.client.prefs.chat_toggles & CHAT_LANGUAGE)
						...
						to_chat(H, "<span class='warning'>�� ������� ��������� ��������� ��������� �����: [round((LENTA_FACTION_MESSAGE_COOLDOWN + last_faction_lenta - world.time)/10)] ���.</span>")
		...
		if("lenta_sound")
			if(switches & FEED_SOUND)
				...
				if(H.client.prefs.chat_toggles & CHAT_LANGUAGE)
					...
					to_chat(H, "<span class='notice'>���� �я��&#2я��������&#255;� � ����� ��������.</span>")
			else
				switches |= FEED_SOUND
				if(H.client.prefs.chat_toggles & CHAT_LANGUAGE)
		...
		if("lenta_images")
			if(switches & FEED_IMAGES)
				...
				if(H.client.prefs.chat_toggles & CHAT_LANGUAGE)
					...
					to_chat(H, "<span class='notice'>������� ��������� �я ������ �� ����� ����������&#255;.</span>")
			else
				switches |= FEED_IMAGES
				if(H.client.prefs.chat_toggles & CHAT_LANGUAGE)
