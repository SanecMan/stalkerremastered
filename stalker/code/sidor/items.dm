...
/sidoritem/kozhanka
	...
	cost = 6000
	words = list("Кожанку" = 5, "кожанку" = 5, "Кожаную" = 5, "кожаную" = 5, "куртку" = 5, "Куртку" = 5, "Кожанка" = 5, "кожанка" = 5, "Кожаная" = 5, "кожаная" = 5, "куртка" = 5, "Куртка" = 5)

/sidoritem/kozhanka/white
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/white
	words = list("Кожанку" = 5, "кожанку" = 5, "Белую" = 5, "белую" = 5, "Кожаную" = 5, "кожаную" = 5, "Куртку" = 5, "куртку" = 5, "Кожанка" = 5, "кожанка" = 5, "Белая" = 5, "белая" = 5, "Кожаная" = 5, "кожаная" = 5, "Куртка" = 5, "куртка" = 5)

/sidoritem/kozhanka/banditka
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/banditka
	words = list("Бандитку" = 5, "Бандитскую" = 5, "бандитскую" = 5, "кожаную" = 5, "Кожаную" = 5, "Куртку" = 5, "куртку" = 5, "Бандитка" = 5, "Бандитская" = 5, "бандитская" = 5, "кожаная" = 5, "Кожаная" = 5, "Куртка" = 5, "куртка" = 5)
...
/sidoritem/kombez
	...
	cost = 22000
	words = list("Кобинезон" = 5, "комбинезон" = 5, "Сталкерский" = 5, "сталкерский" = 5, "Заря" = 5, "заря" = 5)
...
/sidoritem/firstaid/army
	...
	cost = 1000
	words = list("Аптечку" = 5, "аптечку" = 5, "Армейскую" = 5, "армейскую" = 5, "Военную" = 5, "военную" = 5, "Военная" = 5, "военная" = 5, "Атпечка" = 5, "аптечка" = 5)
...
/sidoritem/firstaid/science
	...
	cost = 2000
	words = list("Аптечку" = 5, "аптечку" = 5, "Научную" = 5, "научную" = 5, "Научная" = 5, "научная" = 5, "Атпечка" = 5, "аптечка" = 5)
...
/sidoritem/konserva/govyadina
	...
	words = list("Банку" = 5, "банку" = 5, "Консерированной" = 5, "консервированной" = 5, "Говядины" = 5, "говядины" = 5, "Банка" = 5, "банка" = 5)
...
/sidoritem/vodka
	...
	cost = 300
	words = list("Бутылку" = 5, "бутылку" = 5, "Водки" = 5, "водки" = 5, "Водяры" = 5, "водяры" = 5 , "Казаки" = 5, "казаки" = 5, "Водка" = 5, "водка" = 10)
...
/sidoritem/b545
	...
	cost = 2000
	words = list("Коробку" = 5, "коробку" = 5, "патронами" = 5, "Патронами" = 5, "Патрон" = 5, "патрон" = 5, "Калаша" = 5, "калаша" = 5, "Пятеркой" = 20, "пятеркой" = 20, "Пятерки" = 20, "пятерки" = 20, "5.45x39" = 5, "5.45х39" = 5)

/sidoritem/b545ap
	name = "b545ap"
	itemtype = /obj/item/ammo_box/stalker/b545ap
	cost = 3000
	words = list("Коробку" = 5, "коробку" = 5, "Бронебойными" = 5, "бронебойными" = 5, "Бронебойных" = 5, "бронебойных" = 5, "патронами" = 5, "Патронами" = 5, "Патрон" = 5, "патрон" = 5, "Калаша" = 5, "калаша" = 5, "Пятеркой" = 20, "пятеркой" = 20, "Пятерки" = 20, "пятерки" = 20, "5.45x39" = 5, "5.45х39" = 5)
...
/sidoritem/artifactbelt
	...
	cost = 500
	words = list("Пояс" = 5, "пояс" = 5, "Артефактов" = 5, "артефактов" = 5)
